      ...
      <div className="container mx-auto">
        <div className='flex flex-col gap-y-8 lg:flex-row lg:items-center lg:gap-x-12'>
          <div className='flex-1 text-center font-secondary lg:text-left'>
            <motion.h1 variants={fadeIn('up', 0.3)} initial='hidden' whileInView={'show'} viewport={{ onde: false, amount: 0.7 }} className='text-[55px] font-bold leading-[0.8] lg:text-[110px]'>
              GABRIEL <span>ALVES</span>
            </motion.h1>
            <motion.div variants={fadeIn('up', 0.4)} initial='hidden' whileInView={'show'} viewport={{ onde: false, amount: 0.7 }} className='mb-6 text-[36px] lg:text-[60px] font-secondary font-semibold uppercase leadin-[1]'>
            ...
            <motion.p variants={fadeIn('up', 0.5)} initial='hidden' whileInView={'show'} viewport={{ onde: false, amount: 0.7 }} className='mb-8 max-wid-lg mx-auto lg:mx-0'>
            ...
            <motion.div variants={fadeIn('up', 0.7)} initial='hidden' whileInView={'show'} viewport={{ onde: false, amount: 0.7 }} className='flex text-[20px] gap-x-6 max-w-max mx-auto lg:mx-0'>
              <a href="https://github.com/alvesgabrieel" target="_blank">
                <FaGithub />
              </a>
              <a href="https://www.linkedin.com/in/gabriel-alvesqm-desenvolvedor/" target="_blank">
                <FaLinkedin />
              </a>
              <a href="#">
                <FaInstagram />
          ...
          {/* image */}
          <motion.div variants={fadeIn('down', 0.5)} initial='hidden' whileInView={'show'} className='text-center'>
            <img className='App-logo block mx-auto' src={Image} alt="Image Profile" />
          </motion.div>
        </div>
      </div>
    </section>
